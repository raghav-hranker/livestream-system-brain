...
> Completed tasks are archived under [`../done/tasks/`](../done/tasks/) (same layout); the tables
> below stay as the index and link there. Only open tasks live in this tree.
...
|---|---|---|---|---|
| 01 | [Pin the deployable branch pairing](../done/tasks/01-pin-branch-pairing.md) | AFK | all three + brain | None |
| 02 | [StreamStatusReporter: at-least-once retry](../done/tasks/02-stream-status-retry.md) | AFK | livestream | 01 |
| 03 | [Write-through status cache + socket-join hydration](../done/tasks/03-write-through-status-cache.md) | AFK | livestream | 02 |
| 04 | [StaleStreamSweep: alert on stuck transient statuses](../done/tasks/04-stale-stream-sweep.md) | AFK | nodejs-server | 01 |
| 05 | [Private-mode endpoint + repoint the livestream client](../done/tasks/05-private-mode-endpoint.md) | AFK | nodejs-server + livestream | 01 |
| 06 | [Freeze the shared-Mongo read contract](../done/tasks/06-freeze-read-contract.md) | AFK | nodejs-server + livestream | 01 (soft: after 03) |
| 07 | [Delete the recordings relay and dead setStreamStatus](../done/tasks/07-delete-recordings-relay.md) | AFK | livestream | 01 |
| 08 | [Delete the Room model, room routes, and in-repo viewer UI](../done/tasks/08-delete-room-era-code.md) | AFK | livestream | 01 |
| 09 | [Fail-fast boot validation for LMS config](../done/tasks/09-fail-fast-boot-validation.md) | AFK | livestream | 01 |
| 10 | [Launch acceptance run](10-launch-acceptance-run.md) | HITL | all + production | 02–09, 11–13 |
| 11 | [Private-mode join bootstrap + server-side enforcement](../done/tasks/11-private-mode-join-bootstrap-enforcement.md) | AFK | livestream | 05 |
| 12 | [ls viewer: room-less realignment](../done/tasks/12-ls-roomless-realignment.md) | AFK | ls | 08, 11 |
| 13 | [Notes move to the LMS](../done/tasks/13-notes-move-to-lms.md) | AFK | nodejs-server + ls + livestream | 12 |
| 14 | [Stream-end cleanup dedupe](../done/tasks/14-stream-end-cleanup-dedupe.md) | AFK | livestream | — |
| 15 | [Final-segment reconciliation at stream end](../done/tasks/15-stream-end-final-segment-reconciliation.md) | AFK | livestream | — |
| 16 | [Post-stop re-finalization guard](../done/tasks/16-post-stop-refinalization-guard.md) | AFK | livestream | 14 |
| 17 | [Shared-Redis ownership guard](../done/tasks/17-shared-redis-ownership-guard.md) | AFK | livestream | — |
